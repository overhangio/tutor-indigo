...
FRONTEND_COMPAT_SLOTS.add_item(INDIGO_FOOTER_SLOT)
FRONTEND_COMPAT_SLOTS.add_item(INDIGO_DESKTOP_SECONDARY_MENU_SLOT)
FRONTEND_COMPAT_SLOTS.add_item(INDIGO_MOBILE_HEADER_SLOT)
FRONTEND_COMPAT_SLOTS.add_item(INDIGO_LOGO_SLOT)
